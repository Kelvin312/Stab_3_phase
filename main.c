...
if(tempValue > (ZERO+50) && isRising[adc_wr_input] == 0)
{
...
if(tempValue < (ZERO-200))
{
    isRising[adc_wr_input] = 0;
}

if(tempValue < (ZERO-10) && isFalling[adc_wr_input] == 0)
{
...
else
{
    ...
    {
        isEnable = (phaseCounter > 5);
        if(isEnable){LED1 = 0; LED2 = 0;} else {LED1 = 1; LED2 = 1; timeReg = MIN_TIMEREG+1; }
